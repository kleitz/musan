   ...
   <div class="panel panel-default">
        ...
        <h3>Seller Contact Info</h3>
         <div class="form-group">
          ...
          {!! Form::text('location', $value = $classified->location , $attributes = ['class' => 'form-control', 'name' => 'location' ,'placeholder' => 'Location']) !!}
        </div>
        <div class="form-group">
          {!! Form::label('email', 'Contact Email'); !!}
          {!! Form::text('email', $value = $classified->email , $attributes = ['class' => 'form-control', 'name' => 'email' ,'placeholder' => 'Contact Email']) !!}
        </div>
        <div class="form-group">
          {!! Form::label('phone', 'Contact Phone'); !!}
          {!! Form::text('phone', $value = $classified->phone , $attributes = ['class' => 'form-control', 'name' => 'phone' ,'placeholder' => 'Contact Phone (Optional)']) !!}
        </div>
